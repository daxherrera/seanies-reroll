    ...
    >
      <div className={`flex flex-col w-full`}>
        {reversedNotifications.map((n, idx) => (
          <Notification
            key={`${n.message}${idx}`}
            type={n.type as "success" | "error" | "info"} // Cast the type
            message={n.message}
...
const Notification = ({ type, message, description, txid, onHide }: { type: "success" | "info" | "error"; message: string; description?: string; txid?: string; onHide: () => void }) => {
